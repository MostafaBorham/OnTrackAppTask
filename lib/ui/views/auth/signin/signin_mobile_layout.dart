...
class SignInMobileLayout extends StatefulWidget {
  ...
  @override
  SignInMobileLayoutState createState() => SignInMobileLayoutState();
}

class SignInMobileLayoutState extends State<SignInMobileLayout> {
          ...
          child: Form(
            ...
            child: BlocConsumer<AuthBloc, AuthState>(
              listener: (context, state) {
                if (state is GetSigninEmailState) {
                  _emailController.text = state.email;
                }
                if (state is GetSigninPasswordState) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: state is WaitingSignInState
                          ? CircularLoader(
                          ...
                          : SignBtn(
                              ...
                              onPressed: () {
                                if (_formKey.currentState!.validate()) {
                                  AuthBloc.get(context).add(SignInEvent(
                    ...
                    ChangeAuthPageLine(
                      question: AppStrings.donotHaveAccountKey,
                      authType: AppStrings.signupKey,
                      changeAuthEvent: state is WaitingSignInState
                          ? null
                          : () {
                              Navigator.pushReplacementNamed(
