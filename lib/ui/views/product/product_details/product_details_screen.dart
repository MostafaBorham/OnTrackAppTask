...
import 'product_details_desktop_layout.dart';
import 'product_details_mobile_layout.dart';
import 'product_details_tablet_layout.dart';
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: AppConfigsBloc.currentConnectionStatue ==
                ...
                : AdaptiveLayout(
                    mobileLayout: (context) => ProductDetailsMobileLayout(
                      product: widget.product,
                    ),
                    tabletLayout: (context) =>
                        const ProductDetailsTabletLayout(),
